...
const portfolioHeroContent = {
  PT: {
    hero: {
      name: "Wagner",
      role: "Full Stack Developer | React.js • Next.js • Node.js • Python • C#/.NET | AI Applications (LLMs)",
      ...
      intro: [
        "Desenvolvedor Full Stack com experiência na construção de aplicações web escaláveis e plataformas baseadas em Inteligência Artificial. Atuação com foco em front-end moderno utilizando React.js, Next.js e Vue.js, aliada ao desenvolvimento e integração de serviços backend com Node.js, Python e tecnologias do ecossistema .NET.",
        "Experiência no desenvolvimento de sistemas utilizando Large Language Models (LLMs), automação de workflows e integração entre APIs e serviços distribuídos, contribuindo para soluções inteligentes, orientadas a dados e preparadas para ambientes de produção.",
        "Vivência em arquiteturas de microservices, sistemas distribuídos e processamento orientado a eventos, participando da construção de aplicações com foco em escalabilidade, performance, manutenção e evolução contínua.",
        "Vivência em:",
        "• Desenvolvimento de interfaces escaláveis e responsivas",
        "• Desenvolvimento e integração de APIs REST",
        "• Backend com Node.js, Python e C#/.NET",
        "• Automação de processos utilizando IA e LLMs",
        "• Arquitetura de sistemas distribuídos e microservices",
        "• Observabilidade e monitoramento de aplicações",
        "• Integração entre serviços e aplicações escaláveis",
        "Interesse em oportunidades como Full Stack Developer, atuando em soluções escaláveis, aplicações com Inteligência Artificial, automação de processos e sistemas de alta performance.",
